...
async def extract_entities(
    ...
    async def _process_single_content(chunk_key_dp: tuple[str, TextChunkSchema]):
        ...
        if mode == "origin":      
            ...
            logger.info(f"111111111111111111{final_result}")
            ...
            logger.info(f"22222222222{records}")
            ...
            #通过熵 找到最优解后稳定。 
                ...
                now_glean_index = 0
                while continue_generation and now_glean_index < 3: #entity_extract_max_gleaning:
                    new_candidates = []
                    now_glean_index += 1
