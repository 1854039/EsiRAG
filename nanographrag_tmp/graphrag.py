...
class GraphRAG:
    ...
    def insert(self, string_or_strings,mode,n):
        print(string_or_strings)
        loop = always_get_an_event_loop()
        return loop.run_until_complete(self.ainsert(string_or_strings,mode,n))
    ...
    async def ainsert(self, string_or_strings,mode,n):
        try:
